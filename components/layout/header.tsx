        ...
        <div className="overflow-hidden rounded-2xl border border-border/80 bg-card shadow-2xl shadow-black/10">
          <div className="border-b border-border/70 px-6 py-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Choose a solution based on your reputation and
              privacy needs.
            </p>
          </div>
...
export function Header() {
  ...
  const phoneNumber =
    AGENCY_CONFIG.phone || '+1 (800) 555-0199'
  ...
  const toggleProductSection = (id: string) => {
    setActiveProductSection((current) =>
      current === id ? null : id,
    )
  }
