...
export const HOMEPAGE = {
  ...
  logoMarquee: {
    ...
    note: "Demo logos — replace with authorized client marks",
    logos: [
      { name: "[Client A]", initials: "CA" },
      { name: "[Client B]", initials: "CB" },
      { name: "[Client C]", initials: "CC" },
      { name: "[Client D]", initials: "CD" },
      { name: "[Client E]", initials: "CE" },
      { name: "[Client F]", initials: "CF" },
      { name: "[Client G]", initials: "CG" },
      { name: "[Client H]", initials: "CH" },
    ],
  },
  companyIntro: {
